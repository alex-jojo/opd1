...
EXP="146_qwen3_1.7b_teacher_qwen3_4b_opd_rubric_soft_reroll_low_weight_lr2e-6"
...
GPT_ROLLOUT_SCORE_REROLL_NOHINT_MAX_WEIGHT=0.10 \
...
cp "$RUN_DIR/eval_outputs/summary.csv" "$RUN_DIR/summary_V10_qwen3_1p7b_soft_reroll_low_weight_lr2e-6.csv"
cat "$RUN_DIR/summary_V10_qwen3_1p7b_soft_reroll_low_weight_lr2e-6.csv"
