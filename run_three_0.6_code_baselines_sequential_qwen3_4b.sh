...
RUN_MBPP="${RUN_MBPP:-1}"
EVALPLUS_MAX_TOKENS="${EVALPLUS_MAX_TOKENS:-2048}"
...
STUDENT_MODEL_REPO="${STUDENT_MODEL_REPO:-Qwen/Qwen3-0.6B}"
STUDENT_MODEL="${STUDENT_MODEL:-/workspace/models/Qwen3-0.6B}"
...
EOPD_EXPERIMENT="${EOPD_EXPERIMENT:-eopd_217_qwen3_0_6b_eopd_teacher_qwen3_4b_code_step300}"
OPD_EXPERIMENT="${OPD_EXPERIMENT:-146_qwen3_0_6b_teacher_qwen3_4b_code_step300_vanilla_opd}"
TA_OPD_EXPERIMENT="${TA_OPD_EXPERIMENT:-qwen3_0_6b_ta_opd_teachability_ratio0.1_k16_seed42_teacher_qwen3_4b_code_step300}"
EXOPD_EXPERIMENT="${EXOPD_EXPERIMENT:-146_qwen3_0_6b_teacher_qwen3_4b_code_step300_single_teacher_exopd_lambda_1p25}"
...
eval_common_env() {
    env \
        ...
        EVALPLUS_MAX_TOKENS="$EVALPLUS_MAX_TOKENS" \
...
echo "[run] eval: LCB_RELEASE=$LCB_RELEASE LCB_N=$LCB_N LCB_MAX_TOKENS=$LCB_MAX_TOKENS EVALPLUS_MAX_TOKENS=$EVALPLUS_MAX_TOKENS RUN_LCB=$RUN_LCB RUN_EVALPLUS=$RUN_EVALPLUS RUN_HUMANEVAL=$RUN_HUMANEVAL RUN_MBPP=$RUN_MBPP"
