...
EXP="146_qwen3_1.7b_teacher_qwen3_4b_ablation_random_bucket_lr2e-6"
...
GPT_ROLLOUT_SCORE_HISTORY_BUCKET_MODE=random \
GPT_ROLLOUT_SCORE_HISTORY_RANDOM_BUCKET_SEED=42 \
...
cp "$RUN_DIR/eval_outputs/summary.csv" "$RUN_DIR/summary_ablation_random_bucket.csv"
cat "$RUN_DIR/summary_ablation_random_bucket.csv"
