...
EXP="146_qwen3_1.7b_teacher_qwen3_4b_ablation_no_rubric_shift_lr2e-6"
...
GPT_ROLLOUT_SCORE_RUBRIC_ADV_SHIFT_ENABLE=False \
...
cp "$RUN_DIR/eval_outputs/summary.csv" "$RUN_DIR/summary_ablation_no_rubric_shift.csv"
cat "$RUN_DIR/summary_ablation_no_rubric_shift.csv"
