...
EXP="146_qwen3_1.7b_teacher_qwen3_4b_opd_rubric_reroll_light_nohint_lr2e-6"
...
GPT_ROLLOUT_SCORE_REROLL_APPEND_MIN_SCORE=50 \
GPT_ROLLOUT_SCORE_REROLL_APPEND_MIN_GAIN=5 \
GPT_ROLLOUT_SCORE_REROLL_HINT_LOSS_WEIGHT=0.05 \
GPT_ROLLOUT_SCORE_REROLL_NOHINT_ENABLE=True \
GPT_ROLLOUT_SCORE_REROLL_NOHINT_MIN_SCORE=55 \
GPT_ROLLOUT_SCORE_REROLL_NOHINT_MIN_GAIN=10 \
GPT_ROLLOUT_SCORE_REROLL_NOHINT_MAX_WEIGHT=0.30 \
...
cp "$RUN_DIR/eval_outputs/summary.csv" "$RUN_DIR/summary_V10_qwen3_1p7b_reroll_light_nohint_lr2e-6.csv"
cat "$RUN_DIR/summary_V10_qwen3_1p7b_reroll_light_nohint_lr2e-6.csv"
