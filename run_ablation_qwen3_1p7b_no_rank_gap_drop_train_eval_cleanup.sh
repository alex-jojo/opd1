...
EXP="146_qwen3_1.7b_teacher_qwen3_4b_ablation_no_rank_gap_drop_lr2e-6"
...
cp "$RUN_DIR/eval_outputs/summary.csv" "$RUN_DIR/summary_ablation_no_rank_gap_drop.csv"
cat "$RUN_DIR/summary_ablation_no_rank_gap_drop.csv"
