...
EXP="146_qwen3_1.7b_teacher_qwen3_4b_opd_rubric_reroll_hint_only_lr2e-6"
...
cp "$RUN_DIR/eval_outputs/summary.csv" "$RUN_DIR/summary_V11_qwen3_1p7b_reroll_hint_only_lr2e-6.csv"
cat "$RUN_DIR/summary_V11_qwen3_1p7b_reroll_hint_only_lr2e-6.csv"
