...
EXP="146_qwen3_0.6b_teacher_qwen3_4b_opd_rubric_12bucket_high_thresh_appended_rankgap075_lr2e-6"
...
GPT_ROLLOUT_SCORE_REROLL_NOHINT_MIN_SCORE=65 \
GPT_ROLLOUT_SCORE_REROLL_NOHINT_MIN_GAIN=15 \
GPT_ROLLOUT_SCORE_REROLL_NOHINT_MAX_WEIGHT=0.25 \
GPT_ROLLOUT_SCORE_REROLL_NOHINT_GAIN_NORM=50 \
GPT_ROLLOUT_SCORE_REROLL_HINT_LOSS_WEIGHT=0.25 \
...
GPT_ROLLOUT_SCORE_RUBRIC_ADV_SHIFT_CLIP=0.10 \
GPT_ROLLOUT_SCORE_HISTORY_NUM_BINS=12 \
GPT_ROLLOUT_SCORE_HISTORY_STD_FLOOR=8.0 \
GPT_ROLLOUT_SCORE_HISTORY_NEGATIVE_COEF_SCALE=0.5 \
GPT_ROLLOUT_SCORE_REROLL_APPEND_REQUIRE_IMPROVEMENT=True \
GPT_ROLLOUT_SCORE_REROLL_APPEND_MIN_SCORE=60 \
...
cp "$RUN_DIR/eval_outputs/summary.csv" "$RUN_DIR/summary_V8_qwen3_0p6b_high_thresh_lr2e-6.csv"
cat "$RUN_DIR/summary_V8_qwen3_0p6b_high_thresh_lr2e-6.csv"
