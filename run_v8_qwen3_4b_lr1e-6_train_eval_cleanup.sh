...
EXP="146_qwen3_4b_teacher_qwen3_4b_opd_rubric_12bucket_strong_rankgap075_lr1e-6"
...
cp "$RUN_DIR/eval_outputs/summary.csv" "$RUN_DIR/summary_V8_qwen3_4b_strong_rankgap075_lr1e-6.csv"
cat "$RUN_DIR/summary_V8_qwen3_4b_strong_rankgap075_lr1e-6.csv"
