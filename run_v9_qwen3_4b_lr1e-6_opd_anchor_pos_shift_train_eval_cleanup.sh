...
EXP="146_qwen3_4b_teacher_qwen3_4b_opd_anchor_pos_shift_lr1e-6"
...
sed -i 's/rainer\.nnodes=1/trainer.nnodes=1/' /workspace/opd1/verl/examples/g_opd/run_qwen3-4b-g-opd.sh
...
GPT_ROLLOUT_SCORE_RANK_GAP_DROP_ENABLE=False \
GPT_ROLLOUT_SCORE_RANK_GAP_CASE_STUDY_DIR=null \
GPT_ROLLOUT_SCORE_RANK_GAP_DROP_THRESHOLD=0.95 \
...
cp "$RUN_DIR/eval_outputs/summary.csv" "$RUN_DIR/summary_V9_qwen3_4b_opd_anchor_pos_shift_lr1e-6.csv"
cat "$RUN_DIR/summary_V9_qwen3_4b_opd_anchor_pos_shift_lr1e-6.csv"
